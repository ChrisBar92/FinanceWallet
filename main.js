...
const availableMoey = document.querySelector('.options__available-money')
...
const createNewTransaction = () => {
	...
	<p class="transaction-amount">${amountInput.value}zł <button class="delete" onClick="deleteTransaction(${ID})">
...
const countMoney = money => {
	...
	availableMoey.textContent = `${newMoney} zł`
}
...
const deleteAllTransaction = () => {
	incomeSection.innerHTML = '<h3 class="income-area__header h3__title">Przychód:</h3>'
	expensesSection.innerHTML = '<h3 class="expenses-area__header h3__title">Wydatki:</h3>'
	availableMoey.textContent = '0zł'
	moneyArr = [0]
}
